import { ArrowLeftRight, Scale, TrendingDown, Wallet } from "lucide-react";
...
export function SummaryCards({ summary }: { summary: TransactionsSummary }) {
  ...
  return (
    <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-4">
      ...
      <div className="card p-4">
        <div className="flex items-center gap-2">
          <IconBadge icon={ArrowLeftRight} color="var(--text-tertiary)" variant="soft" size="sm" />
          <p className="text-sm text-[var(--muted)]">Neutro</p>
        </div>
        <p className="mt-2 text-xl font-semibold text-[var(--text-tertiary)]">
