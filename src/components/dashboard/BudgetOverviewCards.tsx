...
/** "Visão Geral" — the classic per-classification summary card (health
 * badge, Orçado/Meta, Realizado/Investido, a progress bar, % gasto or
 * % da meta) plus the Saldo/Resultado gauge, restored here after
 * briefly trying a cash-flow funnel in this slot. Same goal-vs-limit
 * rules as the rest of the page — Investimentos is never penalized for
 * exceeding its meta, see isGoalClassification in src/lib/budget-calc.ts. */
