  ...
  if (state.success) {
    return (
      <div className="space-y-5">
        ...
        {state.devResetLink && (
          <div className="rounded-lg border border-dashed border-[var(--surface-border)] bg-[var(--surface-subtle)] p-3.5 text-sm text-[var(--text-tertiary)]">
            <p className="font-medium text-[var(--text-secondary)]">Modo de desenvolvimento</p>
            <p className="mt-1">
