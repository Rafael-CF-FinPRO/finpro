...
export const DEFAULT_CATEGORY_TEMPLATE: {
  ...
  {
    name: "Alimentação",
    description: "Refeições do dia a dia fora de casa, como almoço no trabalho ou lanches rápidos.",
    type: "SAIDA",
    classification: "CUSTOS_OBRIGATORIOS",
    order: 2,
  },
  {
    name: "Mercado",
    description: "Compras de supermercado para alimentação e itens básicos de casa.",
    type: "SAIDA",
    classification: "CUSTOS_OBRIGATORIOS",
    order: 3,
  },
  ...
  {
    // Not in the reference list for Custos Obrigatórios, but kept here
    // (as it always existed) because the spec's own duplicate-name
    // example explicitly pairs "Cuidados Pessoais — Custo Obrigatório"
    // with "Cuidados Pessoais — Prazer e Conforto" — dropping this side
    // would both contradict that example and silently reclassify real
    // users' existing essential personal-care spending as optional.
    name: "Cuidados Pessoais",
    description: "Itens básicos de higiene e saúde pessoal que você não pode deixar de ter.",
    type: "SAIDA",
    classification: "CUSTOS_OBRIGATORIOS",
    order: 11,
  },
